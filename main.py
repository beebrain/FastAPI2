...
app = FastAPI(
    ...
    description="FastAPI + Ultralytics YOLO สำหรับ Detect วัตถุในภาพถ่าย",
    version="1.0.0",
)
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# yolov8n.pt = Nano model (เล็กที่สุด, เร็วที่สุด, เหมาะสำหรับ demo)
# YOLO จะ auto-detect GPU (CUDA) ถ้ามี หรือใช้ CPU ถ้าไม่มี GPU
# ครั้งแรกที่รัน จะ download weights อัตโนมัติ (~6MB)
...
async def home(request: Request):
    ...
    """
    return FileResponse(BASE_DIR / "standard.html")
...
if __name__ == "__main__":
    ...
    # reload=True เพื่อ auto-reload เมื่อแก้ไขโค้ด (สำหรับ development)
